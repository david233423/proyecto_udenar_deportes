...
@section('content')
    <form action="{{ url('/noticias/editar', $noticia->codigo) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="grid grid-cols-1 mt-5 mx-7">
            <img id="imagenSeleccionada" style="max-height: 300px;" src="/imagen/{{ $noticia->imagen }}">
        </div>
        <div class="grid grid-cols-1 mt-5 mx-7">
